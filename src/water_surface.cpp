...
void water_surface_structure::update_positions(vec3 const& camera_position) {
...
void set_textures_drawable(mesh_drawable& drawable, opengl_texture_image_structure& texture_sand, opengl_texture_image_structure& texture_skybox) {
	drawable.supplementary_texture["texture_sand"] = texture_sand;
	drawable.supplementary_texture["image_skybox"] = texture_skybox;
}

void water_surface_structure::set_textures(opengl_texture_image_structure& texture_sand, opengl_texture_image_structure& texture_skybox)
{
	set_textures_drawable(center, texture_sand, texture_skybox);
	set_textures_drawable(positive_x, texture_sand, texture_skybox);
	set_textures_drawable(negative_x, texture_sand, texture_skybox);
	set_textures_drawable(positive_y, texture_sand, texture_skybox);
	set_textures_drawable(negative_y, texture_sand, texture_skybox);
}
